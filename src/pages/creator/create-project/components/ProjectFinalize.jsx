...
const ProjectFinalize = ({
  ...
  return (
    <>
      ...
      {requestStatus === "createSuccessFull" && <Success showSuccess={true} />}
            ...
            <div style={{ width: 100 + "%" }} className="centerForm">
              ...
              {hireBuidlTalentsChecked && (
                <div className="pt-3">
                  <h4 className="normalPTag fw-medium">
                    This project is made known to project managers on the
              ...
              <div className="d-flex pt-5 align-items-center flex-wrap justify-content-between">
                ...
                {/* <span
                  ...
                  style={{
                    color: "#EEA20E",
                    cursor: team.length > 0 ? "pointer" : "",
                    opacity: team.length > 0 ? 1 : 0.5,
                  }}
                >
                  Save & Continue later
                </span> */}
